...
public class ReadTemplateDump implements Opcodes {
	...
	public static byte[] dump() throws Exception {
		...
		cw.visit(V1_6, ACC_PUBLIC + ACC_SUPER, "ReadTemplate", null,
				"java/lang/Object", null);

		{
			fv = cw.visitField(0, "input", "Ljava/io/BufferedReader;", null,
					null);
			fv.visitEnd();
		}
		{
			mv = cw.visitMethod(ACC_PRIVATE, "readString",
			...
			mv.visitFieldInsn(GETFIELD, "ReadTemplate", "input",
		...
		}
		{
			...
			mv.visitFieldInsn(GETFIELD, "ReadTemplate", "input",
					"Ljava/io/BufferedReader;");
			mv.visitMethodInsn(INVOKEVIRTUAL, "java/io/BufferedReader", "read",
					"()I");
			mv.visitLabel(l1);
		...
		{
			mv = cw.visitMethod(ACC_PRIVATE, "readInteger",
		...
		}
		{
			...
			mv.visitFieldInsn(PUTFIELD, "ReadTemplate", "input",
					"Ljava/io/BufferedReader;");
			mv.visitVarInsn(ALOAD, 0);
			mv.visitMethodInsn(INVOKESPECIAL, "ReadTemplate", "readInt", "()I");
			mv.visitVarInsn(ISTORE, 1);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitMethodInsn(INVOKESPECIAL, "ReadTemplate", "readString",
					"()Ljava/lang/String;");
			mv.visitVarInsn(ASTORE, 2);
			mv.visitInsn(RETURN);
			mv.visitMaxs(6, 3);
